...
# ╔═╡ a0ca77dc-7f12-11ee-0efd-41e9e5613fa5
md"""
- item 1
- another thing
...
# ╔═╡ 94b6a79d-53fa-4bdb-b858-13ab3c8d005b
stringlist = [ "item 1",
"another thing",
"remember this bullet"
]

# ╔═╡ 9286a5ee-6d8d-4170-bfb8-534612d4e9a1
join(map(s -> "- " * s, stringlist), "\n") |> Markdown.parse

# ╔═╡ 6411172f-3d34-4302-b9b8-b9b115c90c03
md"""## Plots"""

# ╔═╡ e7d4c050-2f53-415a-84a7-42fda66ce29e
md"""## Various tips and tricks"""
