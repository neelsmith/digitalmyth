...
# ╔═╡ d428fe27-22b0-4d3f-9382-0ba2f5c213b0
md"""# Working with Pluto notebooks in multiple formats"""

# ╔═╡ 0e4c4f61-cba3-429e-bf6e-64e2d2ccf2fc
md"""Some things you can do with Pluto notebooks:

"""

# ╔═╡ 5fd4ff5c-3797-4434-ac97-54934ec8dbe3
md"""
Export notebook as:
...
Use a running notebook to:

- make a screen recording
- function as a slide show
"""

# ╔═╡ f31bfe41-2c2f-4e3a-a531-098bcb57ce7e
md"""
## The downloads/export menu
"""

# ╔═╡ 9b72bce2-be39-423c-8c2d-78726d7dea34
md"""![](https://raw.githubusercontent.com/neelsmith/digitalmyth/dev/pluto/Pluto-export.png)"""

# ╔═╡ 295d2506-ee15-4ce2-99da-0d1c7b6f2caf
md"""## Useful packages"""

# ╔═╡ d51d6c65-542e-488e-8892-e9bc378950fe
md"""Add a collapsible table of contents browser to your notebook:"""
...
md"""Two ways to generate markdown from a String:

1. The `md` string prefix
2. The `Markdown.parse` function

"""

# ╔═╡ c92aa676-e722-4c9e-9903-4e3a1468e5c2
md"""Markdown with **emphasis**."""

# ╔═╡ aa7a5d11-cf87-4ffe-b1f6-8b0769779dae
"""Markdown with **emphasis**.""" |> Markdown.parse

# ╔═╡ 6411172f-3d34-4302-b9b8-b9b115c90c03
md"""## Plots"""

# ╔═╡ af7aca07-4dd2-4381-a9ac-77ee8244a68b
md"""Easily create bar charts, scatter plots and many others with `PlotlyJS`:
...
namecountstrace = bar(x = ["Zeus", "Hera", "Athena"], y = [20,5,12])
...
# ╔═╡ f5773ff1-71b4-4cb1-adf2-87b4e74e6020
Plot(namecountstrace, layout)

# ╔═╡ dda7686b-80fd-4e21-9416-8d8a5f871e72
md"""## Functions from `PlutoTeachingTools` for formatting blocks

Note that each one of these functions takes a full-blown Markdown object as its paraemter.
"""

# ╔═╡ 0cf55818-fd68-4950-939f-060743e118ee
md"""#### Highlighted **boxes for notes**."""
...
Foldable("See more details", md"> *A full-blown markdown object with as much content as you want to include!*")
...
md"""Note unusual syntax with  `@bind` macro to assign the output of a widget to a Julia variable"""

# ╔═╡ c540e521-7e1e-4ca8-868e-6da3ce0ede80
@bind count Slider(0:10:100, show_value=true)

# ╔═╡ c87d92fc-9d65-4a2a-864e-e471f4c2c880
count

# ╔═╡ 7b58bffd-5775-42f4-bbfc-0bb11e6d6d0c
md"""## References"""
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "d28d6cdd32c86c686d469d00523c7d273f90cf18"
