...
md"""!!! tip "Plot results of ngram query in Google books"
"""

# ╔═╡ baa67e16-0e45-450b-8333-0574aa8ff035
...
!!! note "Data results and plot objects"

"""

# ╔═╡ 4cd45e81-2560-498f-898b-8a07875eae7b
begin
	titlestring = string("Frequency in Google ngram data of ", replace(grams, "," => ", "))
	lyt = Layout(
	title = titlestring,
	xaxis_title = "Year",
	yaxis_title = "Frequency in corpus",
	height = 400
	)
end

# ╔═╡ 69007b16-321e-4bf9-ab63-cd5b9e821d7c
md"""!!! note "UI and forming the query URL"
"""
...
corpora = [
	...
	"de-2019" => "German 2019",
	"iw-2019" => "Hebrew 2019",
	"it_2019" => "Italian 2019",
	"ru_2019" => "Russian 2019",
	"es_2019" => "Spanish 2019",
...
isnothing(grams) ? nothing : md"""*Number of ngrams to plot*: **$(length(answerdicts))**"""

# ╔═╡ a6362013-e1e4-43c2-b15e-192e8bcb2dc9
plotdata = begin
	plotvector = GenericTrace{Dict{Symbol, Any}}[]
	for datadict in answerdicts
		push!(plotvector, scatter(x = collect(startfrom:endwith), y = datadict["timeseries"], name = datadict["ngram"]))
	end
	plotvector
end
...
isempty(grams) ? nothing : Plot(plotdata, lyt)
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "a1b5165cca1a03e1dee8ca1300c05a3f4440d774"
