...
# ╔═╡ 9988b32e-0b90-4a59-bcf9-8662f94d0733
begin
	using PlutoUI
	using Transformers
end

# ╔═╡ 65047971-0ddd-44bd-a73e-6ae50f460035
using Flux: gradient

# ╔═╡ 69ee03a0-7422-11ee-14d0-43d80cf78c31
md"""# Try Flux"""

# ╔═╡ f68cc9c1-8bd3-400b-8c18-f4bda75a309b
f(x) = 3x^2 + 2x + 1

# ╔═╡ 2a25c31f-6a46-44a7-adac-bf4fcf34a6cc
md"""x $(@bind x Slider(1:100, show_value = true))"""

# ╔═╡ 1015c37f-9e32-44c2-9612-7df2339a1fb2
f(x)

# ╔═╡ c27317c9-c47a-4861-9e47-52f7be9c4602
df(x) = gradient(f, x)[1]

# ╔═╡ 7c4ca465-98e6-4da6-b4ca-ba16b3a24a73
df(x)

# ╔═╡ 01c5f238-b7ac-440a-99fa-e3b63636d05b
md"""## Transformers"""

# ╔═╡ e80ce593-3f63-4391-a065-621c4481ef7f
labels = map(string, 1:10)

# ╔═╡ c745be4d-406d-4714-b347-7936b1498fc1
startsym = "<s>"


# ╔═╡ 22d44910-6dc6-43e8-bdfe-393e48594bcd
endsym = "</s>"


# ╔═╡ c97ccff7-b2ac-464b-9a2f-41ddb4138eb5
unksym = "<unk>"


# ╔═╡ bcf337a0-2fb6-48d2-b057-7f3153399ea8
labelvals = [unksym, startsym, endsym, labels...]


# ╔═╡ a33ef81e-e2f4-4683-a235-82781778df1f
textenc = TransformerTextEncoder(split, labelvals; startsym, endsym, unksym, padsym = unksym)

# ╔═╡ d9ea03b1-3b90-4f2a-a63d-1d43bbedd51c
sample_data() = (d = join(map(string, rand(1:10, 10)), ' '); (d,d))


# ╔═╡ 02bdb9fb-88cb-496f-8b48-49f984a7aa21
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "43d32107669ca64bafd71e1c62828d88c270cf80"
...
deps = ["Artifacts", "Base64", "DataStructures", "DoubleArrayTries", "LazyArtifacts", "StructWalk", "TextEncodeBase", "Unicode"]
git-tree-sha1 = "295253961b9bcb1020bfd8711c7b51311dbfa102"
...
git-tree-sha1 = "9667af23bda5ce51bad3dd759812c398a58d8b9d"
...
deps = ["Adapt", "CUDA", "ChainRulesCore", "GPUArrays", "GPUArraysCore", "LinearAlgebra", "NNlib", "NNlibCUDA", "Requires", "Static"]
git-tree-sha1 = "a87d94adcbcb0598c147d09b43dce830bc27baaa"
...
git-tree-sha1 = "b744f8f1cb9a700472529fc58986ab00d86996ae"
...
[[deps.TextEncodeBase]]
deps = ["FuncPipelines", "PartialFunctions", "PrimitiveOneHot", "RustRegex", "StaticArrays", "StructWalk", "Unicode", "WordTokenizers"]
git-tree-sha1 = "4753ea70646cb276a4db65952e59103fbc2b0576"
...
[[deps.Transformers]]
deps = ["Base64", "BytePairEncoding", "CUDA", "ChainRulesCore", "DataDeps", "DataStructures", "Dates", "DelimitedFiles", "DoubleArrayTries", "Fetch", "FillArrays", "Flux", "FuncPipelines", "Functors", "HTTP", "HuggingFaceApi", "JSON3", "LRUCache", "LightXML", "LinearAlgebra", "Mmap", "NNlib", "NNlibCUDA", "NeuralAttentionlib", "Pickle", "Pkg", "PrimitiveOneHot", "Random", "SHA", "Static", "Statistics", "StringViews", "StructWalk", "TextEncodeBase", "Unicode", "ValSplit", "WordTokenizers", "Zygote"]
git-tree-sha1 = "77d831ef0b378cd59c97fd52f1b6e420c972960b"
