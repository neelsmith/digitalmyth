...
# ╔═╡ fa0a68a6-565f-11ee-2ba7-5b26679fc205
begin
using GraphIO
	using GraphIO.DOT
	using Graphs
...
# ╔═╡ f2664d61-1088-4ca7-b7ec-f8293347b3a2
md"""# Graph plotting recipes"""

# ╔═╡ 80e0771c-20ce-4877-9ea9-abf39a7495a4
 f = joinpath(pwd() |> dirname, "test1.dot")

# ╔═╡ d8431073-61f4-4381-8ab3-bffbbe37a708
g = loadgraph(f, "gods", DOTFormat())

# ╔═╡ 09fb8c75-48fe-41d5-a7f7-d750d7cf6a18
labels = ["Hera", "Zeus", "Athena", "Apollo", "Artemis"]

# ╔═╡ 87a670ad-5b74-49af-a8c5-bb7c1b323dcc
graphplot(g, names = labels)
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "eac2d558f77d0a193422c55841a0a6195855ea21"
