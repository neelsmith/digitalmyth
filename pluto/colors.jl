...
# ╔═╡ 293b4032-6dfb-11ee-1dc3-1d156beabd61
using PlotlyJS

# ╔═╡ b722ae3b-f237-451c-ad03-a0c6e018a6ac
xs = ["A", "B", "C", "D"]

# ╔═╡ 9972213c-0738-4f23-a65d-cf1b21cdb628
ys = [1,3,8,5]

# ╔═╡ 4ebeaa0d-ede8-406d-8197-08c170f09e3a
lbls = ["A", "B", "C", "D"]

# ╔═╡ edafaea2-1a00-4185-acd6-614718d464db
tmlyt = Layout(height = 300)

# ╔═╡ 17a68656-1f31-4d85-8b2f-f3fa31f46d0b
colors = Cycler([
        "#E24A33", "#348ABD", "#988ED5", "#777777"
    ])

# ╔═╡ e591338f-3da5-4042-a616-ff44d79374ed
tmscat = scatter(x = xs, y = ys, marker_color = colors, mode = "markers", text = lbls)

# ╔═╡ 3348f519-8d93-4b56-bf4f-344d31cf0ec4
Plot(tmscat, tmlyt)
