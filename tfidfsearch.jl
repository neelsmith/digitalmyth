...
>
> For each matching document, the results display both a full text of the scholion, and a version highlighting the term in a text without accents or breathings.
"""
...
reff = filter(cn -> endswith(passagecomponent(cn.urn), "ref"), c.passages)

# ╔═╡ f60970e8-ca28-458a-b23d-a581c960e3f1
comments = filter(cn -> endswith(passagecomponent(cn.urn), "comment"), c.passages)
...
# ╔═╡ e305b889-fedd-4c38-9b9a-f55cb9a77fb3
corp
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "8f4ec458c84536896f390fbbeae7402fed8e2a9c"
...
git-tree-sha1 = "7e426173dd64a5b39b7324123bf73222a10360ea"
...
git-tree-sha1 = "03612e7a06d2ff7559bf32ec9348c34563530fd5"
...
git-tree-sha1 = "1693f6609cd4c336c817d487dd5953214068232a"
...
git-tree-sha1 = "a85fea27849986949a681981db8308d9c83377a9"
...
git-tree-sha1 = "945957ba6e0190e091c468a9cdf845f499c13687"
...
git-tree-sha1 = "ebe46eb0d6bb7c5321f5367cfb62f7cf4f4befff"
