...
if release_history
md"""
- **3.0.0**: use new version of `CitableCorpusAnalysis` for integrated topic modelling with citable corpora
...
[compat]
CitableBase = "~10.2.1"
CitableCorpus = "~0.12.5"
CitableCorpusAnalysis = "~0.6.1"
CitableText = "~0.15.1"
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "2642fad0e856f64a2bf2621480c98ed45507443c"
...
deps = ["CSV", "CitableBase", "CitableCorpus", "CitableParserBuilder", "CitableText", "Conda", "DocStringExtensions", "Documenter", "HTTP", "Orthography", "PyCall", "Test", "TextAnalysis", "TopicModelsVB"]
git-tree-sha1 = "448f15b70be97291ef27a792730a570b9fabbb41"
