...
g = loadgraph(f, "gods", DOTFormat())

# ╔═╡ b7144a59-3252-478b-a463-7f5a9551768e
g |> vertices

# ╔═╡ 646f9d24-db1e-4d2e-b325-e1fd52a6ef34
labels = ["Hera", "Zeus", "Athena", "Apollo", "Artemis"]

# ╔═╡ 236a021a-2d4a-4416-9593-f9901e01014c
graphplot(g)

# ╔═╡ 97d9ce4c-de02-4f08-a474-fdd3d9192b82
demo = barabasi_albert(60, 1)


# ╔═╡ b1516020-0740-4f10-96b3-3c814bc29a3b
@draw begin
    background("black")
    sethue("grey40")
    fontsize(8)
...
# ╔═╡ 8cd184ee-3448-4293-8ee6-0f2cdefafcca
vlabels = 1:nv(g)

# ╔═╡ 01ee57c9-ecb0-4c62-b9d7-70b4dfacaf88
vfillcolors = 
            [RGB(rand(3)/2...) 
               for i in 1:nv(g)]

# ╔═╡ f3003659-baf1-4ed2-9ed7-639f37ce7b06
@draw begin

	drawgraph(g,
	layout=squaregrid, 
	vertexlabels = labels,
	vertexfillcolors = vfillcolors
	)
end 600 400
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "f98228534ec34bd1e85e5a1ed76c7e5d0eea2729"
...
[[deps.Karnak]]
deps = ["Colors", "DelimitedFiles", "Graphs", "Luxor", "NetworkLayout", "Reexport", "SimpleWeightedGraphs"]
