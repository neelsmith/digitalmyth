...
begin
	...
	md"*Unhide this cell to see the full Julia environment.*"
end
...
# ╔═╡ dc2d75ba-ce99-4442-acde-5d0d2cf2d248
md""">**This notebook uses a lot of external packages to simpilify loading multiple texts into a citable corpus, managing their canonical citation systems, and topic modelling their contents. You can unhide the following cell if you want to see all the packages it uses.**

"""

# ╔═╡ eaaf7152-bf1c-4d84-8f3d-399d1d409b31
md"""
# Building topic models of mythological texts
"""

# ╔═╡ acb20337-1bea-488a-b73c-89e38e9bbdc6
md"""
!!! note "1. Load corpus, edit stop word list"
"""

# ╔═╡ 2021de14-3bc5-4504-8e42-8a665d7fa919
md"""> **Check the following box to load both Apollodorus and Hyginus into a single corpus**."""

# ╔═╡ 0bc12bb2-e1d1-4c14-b5d4-2c897fef3847
md"""*Check this box to load texts*: $(@bind load_texts CheckBox(default = false))"""

# ╔═╡ 8969c875-ad42-4278-bd6f-8fc028c34299
md"""*Treat stop word list as case-insensitive*: $(@bind case_insensitive CheckBox(default = true))"""
...
md"""
!!! note "2. Compute the topic model"
"""

# ╔═╡ e6e0285c-2328-4216-ab83-a54dd8b6bcba
  md"""> **When you have completed editing the stop-word list, set the number of topics to create. Use the `Submit` button to reset the number. Then check "Compute topic model" to create a new topic model of your corpus**.
...
md"""
!!! note "3. Review results: highest term scores for each topic"
"""

# ╔═╡ 852f3c97-c865-44ea-893a-96c7cf3dd271
md""">**Use these results to help you assess your topics. Do the clusters of vocabulary make sense?**"""
...
md"""
!!! note "4. View most significant documents for each topic"
"""

# ╔═╡ 2e809074-7ba0-4a33-b358-1c98bbcb5ec1
md""">**Use these results to find passages that score highly for each topic.**"""

# ╔═╡ c91b4256-1870-48fa-852d-c2c9e38ed536
md"""
!!! note "5. View most significant terms and document for a selected topic"
"""

# ╔═╡ c0040495-9777-4f33-a0b4-a19d43bdcf2c
md""">**Drill down on a specific topic. Find its most important terms, and the passages that rank highest for that topic.**"""
...
md"""
!!! note "6. Choose a passage to compare its text and topic scores"
"""

# ╔═╡ 3b635d98-9635-4b10-acc2-d15c5719edd8
md""">**Drill down on a specific passage. Use the 3D visualiation to identify clusters of documents scoring high on the same topic.  Choose a passage to see its full text and its scores for each topic.**"""

# ╔═╡ d82b6b01-7e0a-48c9-ab45-f50791f80503
md"""*Height of plot (pixels)* """
...
md""" ## Model noteboook for analyzing a corpus with LDA
...
c = if load_texts
	...
	for u in [apollodorus_url, hyginus_url] 
		if case_insensitive
...
# ╠═╡ show_logs = false
tm = stopwordsok & ! isnothing(c) ?  lda_tm(c, k; stopwords = stopwords, iters = iters, doclabels = labels) : nothing
...
function colorkey(label_list,color_list)
	htmllines = []

	for i in 1:length(label_list)
		push!(htmllines, """<p>$(i). <span style="color: #$(hex(color_list[i]))">$(label_list[i])</span></p>""")
	end
	join(htmllines, "\n")
end

# ╔═╡ 456b8623-6b7f-4c5e-87e4-ed204980fdd0
isnothing(tm) ? nothing : aside(HTML("""<p><b>Color key</b></p>
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "d8e859e927435d14b6c067be6b16fe7a7d2696bd"
