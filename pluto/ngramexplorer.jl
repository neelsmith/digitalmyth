...
# ╔═╡ 5d93f4a7-23e3-4eee-9473-8403eab8944b
...
# ╔═╡ 8e135d92-d50e-402b-ba87-6d63bf719e14
text_url

# ╔═╡ b68483f8-0f72-4907-922b-33dce51d888f
lines = isnothing(text_url) | isempty(text_url) ? [] : readlines(Downloads.download(text_url))
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "04018dc2bfd488b09790bc496b3937aa067a8b09"
